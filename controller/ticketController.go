...
func (controller *ticketController) StartTicket(context *gin.Context) {

	var request *model.StartTicketRequest
	...
	if error != nil {
		...
		ticket, error = controller.ticketService.StartTicket(request)
...
func (controller *ticketController) CloseTicket(context *gin.Context) {

	var request *model.CloseTicketRequest
	...
	if error != nil {
		...
		ticket, error = controller.ticketService.CloseTicket(request)
